...
label S12CafeSceneTeamOrigins:
    ...
    m "Is it really such a big deal? I just wanted a practice game against a good player. Seems harmless."
    ...
    m "Cut me some slack. How do you know that guy anyway? His name is Bolt?"
    show jett neutral3 with dissolve
    ...
    m "Huh, okay. I was thinking he might have knocked you out of a tournament or something."
    show jett unimpressed with dissolve
    ...
    m "Hey, I’m not guilting you. It just isn’t something I expected to hear. Do you have a team house picked out?"
    show jett neutral with dissolve
    j "No. Not yet."
    ...
    m "Uh, well, do you have players in mind?"
    ...
    m "What? Where would the money come from if not the fans?"
    j "Idiots."
    m "Er, what?"
    show jett unimpressed with dissolve
    ...
    m "Hey, don't pretend like Brood War didn't get famous on the backs of dudes who looked good on camera. If the PC bang was the ship, then fangirls pulled the oars."
    show jett unimpressed with dissolve
    j "That's different. They were pretty and skilled, not one or the other." 
    j"And show some respect. Those 'dudes' are the only reason you and I are able to have this conversation."
    ...
    m "You could always hire a manager."
    ...
    m "No, don’t do that. I think it's a good idea."
    show jett unimpressed with dissolve
    j "You’re only saying that because I gave you an offer."
    m "Maybe. But hey, if you go through with this, I’ll do whatever I can to help."
    show jett considering with dissolve
    ...
    m "You know, this isn’t exactly what I had in mind as the ideal 'join a team' experience."
    show jett neutral3 with dissolve
    ...
    jump S13ConvenienceStore

label S13ConvenienceStore:
...
label S14FindingStuntPlayer:
    ...
    m "It’s a big change, I guess. And c’mon, I just met you guys. How can she not be hesitant?"
    ...
    show accel confident with dissolve
    a "I could give you his info for a friend request, but he’d probably block you on the assumption that you’re a fanboy or a goldseller or something."
    ...
    stop music fadeout 3.0
    window hide dissolve
    jump S15RecruitingStuntPlayer

label S15RecruitingStuntPlayer:
    ...
    somekid1 "Another chobo is gonna try to betmatch Stunt?"
    ...
    "Stunt ignores the peanut gallery and takes a step forward, sizing me up. Judging by his appearance, it looks like he just started high school. I’m at least a head taller than him."
...
label stuntlose:
    ...
    s "You’re just trying to get out of paying for your loss. That’s real low, man. Real low."
    show stunt notcool with dissolve
    ...
    s "Yeah, people have tried this sketchy shit with me before. It’s not happening. I paid for your PC, and now you repay me with this crap? Get lost, man."
...
label stuntwin:
    ...
    m "No, a Korean one. And Accel said you’d probably assume I was a fanboy and block me. Although, I get the feeling that was just his excuse for this whole setup..."
    "Man, Accel. Couldn't we have just kept this simple? What if I had lost?!"
    ...
    s "Alright dude, consider me signed. If I've got a room and enough money to pay for food, we’re in business."
    show stunt neutral at center with dissolve
    ...
    m "Sounds good. Welcome aboard, kid."
...
label S16Reflection1:
    ...
    "With a look back at the computer screen, I notice that my inbox has a message awaiting. A click, and I’m staring and at a piece of fanmail, the first I’ve received in a month."
    play voice "sfx/click.ogg"
    show image "bg/epicmeme.jpg":
        xalign 0.5 yanchor 0.5 ypos 0.5 subpixel True
    with dissolve
    "Maybe it's inaccurate to call it fanmail considering I've known this guy since before I first started playing StarCraft in high school."
    "Stream? What, so ten people can watch me play faceless barcodes all day? Pointless. Maybe if I got enough viewers to make some money."
    "He and I really didn't even talk back in school. It wasn't until he found out about my StarCraft skill after graduation that he tried to become my friend."
    show image "bg/epicmeme.jpg":
        alpha 1.0 xalign 0.5 yanchor 0.5 ypos 0.5 subpixel True
        easeout .5 ypos 0.6 alpha 0.0 subpixel True
    $ renpy.pause(.5)
    "I massage my temples, frustrated. All that message did was put me in a bad mood."
    ...
    stop sound fadeout 2.0
    stop music fadeout 2.0
    jump S17AccelsTipAboutRevaPlayer

label S17AccelsTipAboutRevaPlayer:
    scene black with midfade:
        align(0,0)
    pause 1
    ...
    play sound "sfx/apmsound.ogg" fadein 2.0 loop
    window show dissolve
    "My sweatshirt's hood held up against the rain for most of the way, but my hair ended up soaked in the end." 
    ...
    a "He’s got a very specific playstyle. It’s almost like playing against a highly advanced A.I. Strong mechanically, but only goes for standard {color=#FF5E5E}macro{/color} games."
    ...
    m "Fine. By the way, what are you so busy with this afternoon?"
    show accel concerned with dissolve
    ...
    window hide dissolve
    stop music fadeout 2.0
    jump S18BattleRevaOnline

label S18BattleRevaOnline:
    scene black with squares:
        align (0, 0)
    pause 1
...
label revalose:
    ...
    "Does this mean I need to continue with the koth? I hadn’t considered that. Gotta wrap up a conversation with Reva quickly in that case."
...
label revawin:
    ...
    window hide dissolve
    jump  S19MeetupWithRevaPlayer

label S19MeetupWithRevaPlayer:
    scene black with midfade:
        align(0,0)
    pause 2
    play music "sfx/Blue Pineapple.ogg" fadein 4.0
    ...
    r "Yes, I am."
    show stunt neutral with dissolve
    m "Oh, I’m sorry! I didn’t realize that you were a girl. I just assumed..."
    ...
    show stunt notcool with dissolve
    s "Man, Mach, you didn’t tell me that this chick was so uptight. Is the rest of the team this lame?"
    show reva neutral with dissolve
    ...
    "The three of us share a long look at one another. Before any other thought can come to mind, Reva ends the silence."
    show reva glasses with dissolve
...
label S20MeetMrKim:
    ...
    stop music fadeout 4.0
    jump S21StuntAndJettPlayers

label S21StuntAndJettPlayers:
...
label S23Bar:
    ...
    m"It’s... {w=.5}good..."
    show accel laughing with dissolve
    a "How does a guy learn Korean without coming across soju at least once? It's kind of impressive, actually."
    ...
    menu:
        "Stunt is right.":
            window show dissolve
            hide stunt
            show jett considering at right:
            show reva neutral at left:
            with dissolve
            m"I mean, what he’s saying is true. Women don't have to be as good at the game to get noticed by teams or sponsors."
            show jett unimpressed with dissolve
            j "That is such bullshit. The types of girls you’re talking about aren’t even really players. They’re mascots. Just there to bring attention to their teams."
            show jett smile with dissolve
            j "Just like you, Mach."
            m "Making up for all the times you were bullied in school, are we? Jeez."
            show jett pleased
            show reva glasses
            with dissolve
            r "The give and take is not in our favor. I find it easier to avoid disclosing my gender entirely."
            hide jett
            hide reva
            show stunt phone at center
            with dissolve

            s "Don’t waste your breath, Mach. There’s no convincing these two."

        "Jett and Reva are right.":
            window show dissolve
            m"It’s hard for everyone, Stunt. But you have to admit that girls trying to make it in eSports have to worry about things that guys don’t give a second thought."
            show stunt neutral with dissolve
            s "Psh. Like?"
            hide stunt
            hide reva
            ...
            "Jett snatches her glass off the table and snaps her arm back. When Stunt recoils and shrinks beneath the table, she returns her drink to her lips with a satisfied smirk."
            show stunt yell
            show jett pleased
            with dissolve
...
label choicestart:
    menu:
        "Most likely to end up a NEET" if bar_choice_reva == False:
            jump RevaBar
        "Most likely to have the worst fans" if bar_choice_jett == False:
            jump JettBar
        "Most likely to bang a fan" if bar_choice_accel == False:
            jump AccelBar
        "Most likely to be a virgin" if bar_choice_stunt == False:
            jump StuntBar
...
label BarEnd:
    ...
    with dissolve
    r "Thank you for treating us to dinner, Jett."
    #might change this
    show jett smile with dissolve
    j "Now there’s a terran that knows how to manner-up. It’s probably because she can play zerg. Take note, boys."
    m "Reva, you alright? Need any help getting home?"
    show reva neutral with dissolve
    r "Oh. {w=.5}Hm. {w=.5}I would not mind assisting you in returning Stunt to—{w=1}{nw}"
    show jett neutral3 
    show reva neutral2
    with Dissolve(.4)
    j "Denied. You're on your own, Mach. Need to talk team business with Reva."
    m "Oh. Right then."
    hide jett
    hide reva
    show accel neutral at center
    with dissolve
    a "I'm out, stuff to do. Later team."
    hide accel with dissolve
    "With a salute, Accel makes his way out of the bar. I’m left to wake Stunt while Jett speaks hushedly to Reva."
    #female mach different scene here
    m"Kid. Wake up. I’m taking you home."
    ...
    "I brace myself and, after pocketing Stunt’s phone off of his head, heave him onto his feet. He’s light, which makes the effort easier than I was expecting. Jett calls after me as we go."
    hide stunt with dissolve
    j "Don’t dump him in an alley. We need a protoss."

    m "Yeah, yeah."

    "I practically carry Stunt outside, offering the bar’s patrons and staff a shameless smile as I make my way through the doorway."
    stop sound fadeout 2.0
    stop music fadeout 2.0
    window hide dissolve
    scene bg streetsidenight with dissolve:
        align (0, 0)
    window show dissolve
    "It doesn’t take much effort to hail a cab and pitch the underaged-drinker inside. Once I’ve made room for myself, I climb in and close the door."
    window hide dissolve
    play voice "sfx/car.mp3"
    $ renpy.pause(.5)
    jump S24OnlinePanic

label S24OnlinePanic:
    scene black with midfade:
        align (0,0)
        pause 2
    ...
    "Without any idea where Stunt's house was, I had the cab drop him off at Stomping Grounds. The last thing I remember was a glare capable of killing small animals from his mother."
    ...
    m_nvl  "{cps=0}yeah, what’s stopping that kim dude from signing us? accel is kind of right. we have buzz going now." 
