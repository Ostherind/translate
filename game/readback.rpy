init -3 python:
    ...
    style.readback_window.ymaximum = 600
    style.readback_window.align = (0, 0)
    
    style.readback_frame.background = None
    style.readback_window.background = "gui/readback/readbackbg.png"
    style.readback_frame.xpadding = 0
    style.readback_frame.xmargin = 0
    style.readback_frame.ymargin = 0
    
    style.readback_frame.xpos = 0
    style.readback_frame.ypos = -50
    ...
    config.readback_buffer_length = 20 # number of lines stored
...
screen text_history:
    ...
    window:
        ...
        side "c r":
            ...
            bar adjustment adj style 'vscrollbar' xpos 250 ypos 0
