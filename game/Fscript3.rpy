...
label fS34DayBeforeLan:
    ...
    with dissolve
    j  "She's barely practiced mech! Why would you even suggest that?"
    show reva expected with dissolve
    r "It is the ideal unit composition when played at its apex."
    show jett unimpressed with dissolve
    j "Only if she can get there safely, which’ll be practically impossible against a protoss as lethal as Bolt."
    show reva neutral with dissolve
...
label fS35ShowmatchWithBolt:
    ...
    "The foundation on my face isn't a kind I've used before and feels a bit weird. Standard procedure for all broadcasted matches, or so the makeup artist said as she applied it."
    ...
    analyst "What about his opponent, Mach? Do we know much about her?"

    caster "There was very little information available about her online, so we must assume that she is an amateur. All the same, she must be quite skilled for Jett and Accel to call her their teammate."
    ...
    hide bg
    show image "bg/flashback1b.jpg" at center
    with Dissolve(.1)
    play voice "sfx/zing.ogg"
    show image "bg/flashback2b.jpg" at center
    with Dissolve(.1)
    show white at center with Dissolve(.1)
    ...
    b "I am confident that I'll only drop one map today. My opponent's year of StarCraft 2 must have earned her at least one win against my single week."
    ...
    show image "bg/cg4female.png" at center:
        xpos 1.5
        easein .2 xpos .5
...
#####################
init python:
    renpy.music.register_channel("FTrack1", "music", True)
    renpy.music.register_channel("FTrack2", "music", True)
    renpy.music.register_channel("FTrack3", "music", True)
    renpy.music.register_channel("FTrack4", "music", True)
    renpy.music.set_volume(1, 0, channel="FTrack1") 
    renpy.music.set_volume(0, 0, channel="FTrack2") 
    renpy.music.set_volume(0, 0, channel="FTrack3") 
    renpy.music.set_volume(0, 0, channel="FTrack4") 


    
play FTrack1 "sfx/zhi.ogg"
queue FTrack1 "sfx/zh.ogg"
play FTrack2 "sfx/zhi.ogg"
queue FTrack2 "sfx/zh3.ogg"
play FTrack3 "sfx/zhi.ogg"
queue FTrack3 "sfx/zh4.ogg"
play FTrack4 "sfx/zhi.ogg"
queue FTrack4 "sfx/zh5.ogg"
...
label fshowmatch1:
    ...
    window hide dissolve
    stop sound fadeout 1.0
    $ renpy.music.set_volume(.3, 1, channel="FTrack1") 
...
label fshowmatch2:
    ...
    init:
        $ timer_range = 0
        $ timer_jump = 0
    $ renpy.music.set_volume(1, 1, channel="FTrack1") 
...
label fshowmatch2boltrush:
    ...
    window hide dissolve
    stop FTrack1 fadeout 1.0
    $ renpy.music.set_volume(.5, 1, channel="FTrack2") 
label fshowmatch3:
    ...
    window hide dissolve
    stop sound fadeout 1.0
    $ renpy.music.set_volume(.3, 1, channel="FTrack2") 
    scene bg booth at center with dissolve
    window show dissolve
    a "Knock knock."
    play sound "sfx/slidingdoor.ogg"
...
label fshowmatch4:
    ...
    scene bg showmatch4 opening with dissolve: 
        align(0,0)
    stop FTrack2 fadeout 1.0
    $ renpy.music.set_volume(.5, 1, channel="FTrack3") 
    window show dissolve
    ...
    hide white with Dissolve(0.1)
    scene bg booth at center with dissolve
    $ renpy.music.set_volume(.3, 1, channel="FTrack3") 
    window show dissolve
    ...
    hide jett with dissolve
    window hide dissolve
    stop FTrack3 fadeout 1.0
    $ renpy.music.set_volume(.5, 1, channel="FTrack4") 
label fshowmatch5:
    ...
    window hide dissolve
    $ renpy.music.set_volume(0, 1, channel="FTrack4") 
    hide showmatch5
...
label fS36Finale:
    ...
    scene black with squares:
        align (0,0)
    pause 1
    show image "bg/cg5femach.jpg" at center
    with slowfade
    window show dissolve
