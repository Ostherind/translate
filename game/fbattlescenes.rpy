...
label falloutattack2:
    ...
    menu:
        "Hit and run with hellions":
            jump falloutattack2hellions
        "Air assault with banshees":
            jump falloutattack2banshee

label falloutattack2hellions:
    ...
    show screen flamethrower_particles_right
    ...
    stop sound fadeout 1.0
    jump falloutattack2end


label falloutattack2banshee:
...
label fjett_practice:
    ...
    play sound "sfx/battle/bansheeexplosion.ogg" fadein 1.0
    show blast_green at blast
    show screen baneling_particles
    show white at flash
    show baneling_goo:
        align(0,0)
    show bg jettpractice explosions with Shake((0.5, 1.0, 0.5, 1.0), .3, dist=8):
        align(0,0)
    hide baneling_goo with Dissolve(1)
...
label fboltgame:
    ...
    menu:
        "Risk an early third base":
            jump fboltgame_fastthird
        "Get aggressive with dropships":
            jump fboltgame_drop
    #return

label fboltgame_cheese:
    play sound "sfx/battle/buildingplaced.ogg" fadein 1.0
...
jump fboltlosecheese

label fboltgame_fastthird:
...
label fstuntgame:
    ...
    menu:
        "Counter-attack with marines":
            jump fstuntgame_counter
        "Stay on the defensive":
            jump fstuntgame_stay


label fstuntgame_counter:
    scene bg black with dissolve:
        align(0,0)
...
label frevabattle1:
    ...
    "There's a specific proxy build that works really well on this map, especially against the type of player that Accel described Reva as. I might risk angering the person I'm trying to recruit, though."
...
label fstudio_game1:
    ...
    "Spawning in at the 7 o’clock position for Team Crash is the blue protoss player, JangL!"
    "His opponent from Team KaiNE at the 2 o’clock base is Shing!"
