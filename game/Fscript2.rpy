...
label fS25ShowmatchOrganization:
    #elv sfx
    ...
    show kim frust5 with dissolve
    k "That may be so, but the public perception of Mach remains an issue. Is it worth the trouble of keeping her on when your reputation has been compromised?"
    show jett neutral with dissolve
    ...
    k "Against someone from your team? Fans will assume that the match is fixed on her behalf."
...
label fS26MachNeedsPractice:
    ...
    "I wipe the sweat from my neck and steady myself with a breath."
    ...
    s "Do you have a better idea!? What the hell would she get out of practicing with a terran or a zerg?"
    show jett casual
    show stunt phone
    with dissolve
    ...
    j "Go with Mach and watch her ladder for the rest of the day. See if you can pick up on any holes in her play."
    ...
    m "No, no. Why don’t you meet me there in an hour? You won't need to stay too long."
    show reva neutral with dissolve
    r "Very well. I will see you in an hour."
    ...
    window hide dissolve
    show image "bg/cg6_1b.jpg" at center with dissolve
    window show dissolve
    ...
    window hide dissolve
    show image "bg/cg6_2b.jpg" at center with dissolve
    window show dissolve
...
label frevaroom3:
    ...
    m "In it for the eSports money, I see."
    show reva neutral with dissolve
    ...
    "The trash on my desk is gone and my bed is made. Hm."
    "... Right. Reva."
    ...
    "... She borrowed some of my clean clothes? Really?! Ugh, well, at least she admitted it."
    ...
    "I reach for another calming breath, but find no relief. It’s that smile of his."
    ...
    show accel neutral
    with dissolve
    j "Whatever. Mach, if you’re going to be showy, save it for when it’ll gain you some fans."
    show stunt neutral grin with dissolve
    ...
    window hide dissolve
    stop sound fadeout 2.0
    jump fS29GettingDinner
#YOU CANT WIN
label fS29GettingDinner:
    scene black with midfade:
        align (0,0)
    ...
    show stunt yell with dissolve
    s "God. The chicks on our team are all so boring."
    show accel thinking2 with dissolve
    ...
    stop sound fadeout 2.0
    window hide dissolve
    jump fS30Reflection2

label fS30Reflection2:
    scene black with squares:
        align (0, 0)
    pause 2
    ...
    "'It’s a video game. Why do you care so much? Do something that you're better suited for.'"
    ...
    "'Hey. Get up. The team is waiting for you.'"
    ...
    scene bg cg3:
        align (0,0) zoom 1.0
        linear 30 xpos -.15
    show image "bg/cg3female.png" at center:
        zoom 1.0 xpos .5
    ...
    show stunt smug with dissolve
    s "Pft, says you. But hey, good that you're already feeling better. If you puke, I'll know it's because my build is what's sick." 
    ...
    show reva glasses with dissolve
    r "It may be more productive for her to face opponents on ladder."
    show accel thinking3 with dissolve
...
label fPCChoice:
    window hide dissolve
    menu:
        "Practice with Reva" if fpc_reva == False:
            jump fRPrac
        "Look for another protoss" if fpc_protoss == False:
            jump fLookFor
        "Something else":
            jump fgogo
label fRPrac:
...
label fgogo:
    ...
    #add more
    s "So I don’t have to worry about anything except destroying Mach? This is going to be great. Hey, Reva, build two gateways by her base for me."
...
label fpostarchon1:
    ...
    show jett neutral at left
    with dissolve
    a "Four more days of that, and she’ll be as ready as she possibly can be in that amount of time."
    show jett considering with dissolve
...
label fS33TrainingMontage:
    ...
    show jett casual with dissolve
    j  "It’s scientifically proven to work. Besides, it’s not like I’m giving her the rest of the day to do as she pleases."
